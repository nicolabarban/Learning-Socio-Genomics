...
The notes are written in the .tex [template](https://www.cs.cmu.edu/~ggordon/10725-F12/template.tex) borrowed from CS267, Applications of Parallel Computing at the UCBerkeley EECS Department with code syntax highlighting done with [minted](https://github.com/gpoore/minted), compiled through XeLateX. There are also some (hopefully) functions written in Python and R related to this specialization. The courses are:
